...
const voiceInstructions = [
  {
    title: "Ready Stance",
    description: "Stand tall with neutral spine and feet shoulder-width apart.",
    keyPoints: ["Neutral spine", "Feet shoulder-width", "Posture aligned"]
  },
  {
    title: "Initiate Movement",
    description: "Lower your hips while keeping your chest up and core engaged.",
    keyPoints: ["Hips lowering", "Chest up", "Core engaged"]
  },
  {
    title: "Mid Descent",
    description: "Hips move back, knees bend to about 90 degrees.",
    keyPoints: ["Hips back", "Knees 90°", "Weight on heels"]
  },
  {
    title: "Bottom Position",
    description: "Maintain stability, balance on your heels, and arms engaged if lifted.",
    keyPoints: ["Maintain balance", "Heel pressure", "Arm position"]
  },
  {
    title: "Begin Ascent",
    description: "Drive upward through the heels, keeping your back straight.",
    keyPoints: ["Drive through heels", "Back straight", "Controlled rise"]
  },
  {
    title: "Returning Up",
    description: "Knees and hips extend, torso remains aligned.",
    keyPoints: ["Knees extend", "Hips extend", "Torso alignment"]
  },
  {
    title: "Full Recovery",
    description: "Stand tall again with arms at your sides and posture upright.",
    keyPoints: ["Stand tall", "Arms relaxed", "Posture upright"]
  },
];

// Animation step time ranges (in seconds)
const stepRanges = [
  [0.0, 0.5],   // Ready stance
  [0.5, 2.5],   // Initiate movement
  [2.5, 3.5],   // Mid descent
  [3.5, 4.5],   // Bottom position
  [4.5, 5.5],   // Begin ascent
  [5.5, 6.5],   // Returning up
  [6.5, 7.5],   // Full recovery
];
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.headerTitle}>Olympic Clean & Jerk Tutorial</Text>
