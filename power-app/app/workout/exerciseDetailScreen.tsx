...
export default function ExerciseDetailScreen() {
  ...
  const endpoint = 'http://192.168.8.182:5000/processVideo';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        {processedVideoUri ? (
          ...
          Platform.OS === 'web' ? (
            !recording ? (
              <Button title="Record 5s Video (Web)" onPress={startRecording} />
            ) : (
              <Text>Recording in progress...</Text>
            )
          ) : (
            !recording ? (
              <Button title="Record 5s Video (Mobile)" onPress={startRecording} />
            ) : (
